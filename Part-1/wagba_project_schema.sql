...
CREATE TABLE IF NOT EXISTS "Delivery_Captain" (
	...
	"current_status"	TEXT NOT NULL CHECK("current_status" == "offline" || "current_status" == "available" || "current_status" == "on_delivery"),
...
CREATE TABLE IF NOT EXISTS "Delivery_Captain_Ledger" (
	...
	"earning_type"	TEXT NOT NULL CHECK("earning_type" == "bonus" OR "earning_type" == "base" OR "earning_type" == "tip"),
...
CREATE TABLE IF NOT EXISTS "Item" (
	...
	"is_available"	TEXT NOT NULL CHECK("is_available" == "YES" || "is_available" == "NO"),
	PRIMARY KEY("item_id"),
...
CREATE TABLE IF NOT EXISTS "Order" (
	...
	"status"	TEXT NOT NULL CHECK("status" == "pending" || "status" == "accepted" || "status" == "preparing" || "status" == "deliverd" || "status" == "out_for_delivery" || "status" == "cancelled"),
	"type"	TEXT NOT NULL CHECK("type" == "ASAP" || "type" == "scheduled"),
...
CREATE TABLE IF NOT EXISTS "Order_Item_Modifiers" (
	"order_item_modifier_id"	INTEGER,
...
CREATE TABLE IF NOT EXISTS "Payment" (
	"payment_id"	INTEGER,
	"order_id"	INTEGER NOT NULL,
	"payment_method"	TEXT NOT NULL CHECK("payment_method" == 'Cash on Delivery' OR "payment_method" == 'Credit Card' OR "payment_method" == 'Wallet Deduction'),
	"status"	TEXT NOT NULL CHECK("status" == 'pending' OR "status" == 'complete' OR "status" == 'failed'),
	PRIMARY KEY("payment_id"),
	FOREIGN KEY("order_id") REFERENCES "Order"("order_id")
);
CREATE TABLE IF NOT EXISTS "Promocode" (
	"promocode_id"	INTEGER NOT NULL UNIQUE,
	"type"	TEXT NOT NULL CHECK("type" == 'fixed' OR "type" == 'percentage'),
...
CREATE TABLE IF NOT EXISTS "Transaction" (
	...
	"order_id"	INTEGER NOT NULL,
	"type"	TEXT NOT NULL CHECK("type" = 'credit' OR "type" = 'cod' OR "type" = 'debit'),
	"created_at"	TEXT NOT NULL,
	"amount"	INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Wallet_Ledger" (
	...
	"amount"	INTEGER NOT NULL,
	"type"	TEXT NOT NULL CHECK(("type" = 'credit' OR "type" = 'debit')),
	"created_at"	TEXT NOT NULL,
	PRIMARY KEY("transaction_id"),
	FOREIGN KEY("customer_id") REFERENCES "Customer"("customer_id"),
	FOREIGN KEY("order_id") REFERENCES "Order"("order_id")
...
CREATE TABLE IF NOT EXISTS "captain_phone_number" (
	"captain_id"	INTEGER,
	"phone_number"	TEXT,
	"is_primary"	TEXT NOT NULL CHECK("is_primary" == "YES" OR "is_primary" == "NO"),
